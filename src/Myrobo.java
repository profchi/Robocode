...
public class Myrobo extends AdvancedRobot {
	...
	public void onBattleEnded(BattleEndedEvent evnt)
	{
		...
		String location = "C:\\Users\\CHINEDU PC\\eclipse-workspace\\Robocodetest\\src\\outputs\\After\\Useless.txt";
		try {
		...
		location = "C:\\Users\\CHINEDU PC\\eclipse-workspace\\Robocodetest\\src\\outputs\\After\\QvaluesUseless.txt";
		try {
	        BufferedWriter writer = new BufferedWriter(new FileWriter(location));
	            for (double x: states) {
	                writer.write(x + "");
